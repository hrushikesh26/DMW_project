...
if (isset($_POST['submit']))
{
  ...
  $ans = exec("Rscript DecisionTree.R $codeno $ClumpThickness $CellSize $CellShape $Adhesion $EpiSize $BareNuclei $Chromatin $Nucleoi $Mitoses");
  echo "<br />Decision Tree<br />";
  echo "BCW <br /> $ans <br />";
  echo "</p>";
}
?>
